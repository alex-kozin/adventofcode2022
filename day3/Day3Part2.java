    ...
    public static void main(String[] args) {
        try {
            ...
            while (inputReader.hasNextLine()) {
                String data1 = inputReader.nextLine();
                String data2 = inputReader.nextLine();
                String data3 = inputReader.nextLine();
                HashSet<Character> backpack1 = getBackpackItems(data1);
                HashSet<Character> backpack2 = getBackpackItems(data2);
                HashSet<Character> backpack3 = getBackpackItems(data3);
                List<Character> common = backpack1.stream().filter(backpack2::contains).filter(backpack3::contains).collect(Collectors.toList());
